...
#######################################
# link script
LDSCRIPT = STM32L010F4Px_FLASH.ld
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32l0x mass_erase 0; exit"
